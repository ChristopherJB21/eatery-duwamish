                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                                <asp:Button runat="server" ID="btnSave" CssClass="btn btn-primary" Width="150px"
                                    Text="SAVE" ValidationGroup="InsertUpdateRecipe" OnClick="btnSave_Click">
                                </asp:Button>
                            </div>
                        </div>
                    </div>
                    ...
                    <asp:Repeater ID="rptRecipe" runat="server" OnItemDataBound="rptRecipe_ItemDataBound" OnItemCommand="rptRecipe_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr class="odd" role="row" runat="server" onclick="">
                                ...
                                <td class="text-center align-middle">
                                    <asp:Button CssClass="btn btn-primary" ID="btnDetail" runat="server" CommandName="DETAIL" Text="DETAIL" ></asp:Button>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
